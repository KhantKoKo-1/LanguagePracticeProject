...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo $base_url;?>assets/common/css/vendors/owl-carousel-2/owl.theme.default.min.css">
        ...
        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
          <div class="card col-lg-4 mx-auto">
            <div class="card-body px-5 py-5">
              <h3 class="card-title text-left mb-3" stt>Login</h3>
              <form method="post">
                <?php if($invalid) {?> 
                <div class="alert">
              ...
              <?php } ?>
                <div class="form-group">
                  <label>Email</label>
                  <input type="text" class="form-control p_input" name="email" id="name" value="<?php echo htmlspecialchars($email);?>" >
                ...
                <div class="form-check">
                    <input  type="checkbox" class="form-check-input" value="1" name="remember" id="remember" <?php if($remember == '1'){echo "checked";} ?> >
                ...
                <p class="sign-up">Don't have an Account?<a href="<?php echo $base_url;?>template/user/register.php"> Sign Up</a></p>
              </form>
            </div>
          </div>
        </div>
